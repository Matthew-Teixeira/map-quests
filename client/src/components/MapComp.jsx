      ...
      >
        {coordinates.map((coord, index) => (
          <div key={index}>
            ...
            {selectedMarker && selectedMarker.longitude === coord.longitude && selectedMarker.latitude === coord.latitude && (
              <Popup
                longitude={coord.longitude}
                latitude={coord.latitude}
                ...
                closeOnClick={true}
              >
                <div>{coord.name}</div> {/* Display the name associated with the coordinates */}
              </Popup>
            )}
          </div>
        ))}
